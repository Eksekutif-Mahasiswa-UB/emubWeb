...
const VisiMisi = () => {
    ...
    return (
        <section ref={progres} className="lg:flex py-20  gap-10 px-4 lg:px-24 bg-primary-white">
            <div className="size-8 lg:size-[5%] sticky top-[45vh] flex justify-center z-50  items-center">
            ...
            <div className="lg:text-7xl text-4xl flex w-full justify-between font-helvetica-extraBold">
                <div className="">
                <motion.h2
                    ref={visi}
                    className={`
  ...
  `}
   ...
   `}
            ...
            <div className="sticky w-3/5 flex justify-center items-center top-[30vh] h-[50vh] ">
                <motion.p 
                className={`${visiIsInView?"opacity-100":"opacity-0"} duration-200 ease-in-out absolute text-primary-charcoalGray text-base lg:text-3xl font-helvetica-regular`}>
                ...
                <p className={`${misiIsInView?"opacity-100":"opacity-0"} duration-200 ease-in-out absolute  text-primary-charcoalGray text-base lg:text-3xl font-helvetica-regular`}>
