  ...
  return (
    <section className="py-10 px-4 lg:px-24 mt-5 lg:mt-20 container mx-auto font-helvetica-regular">
      ...
      >
        {loading ? (
        skeleton.map((item)=>(
            <SplideSlide className="py-5">
          
            <Skeleton
                className= " w-full relative group p-3 lg:p-7 flex items-end shadow-md mx-auto hover:bg-opacity-100 duration-500 ease-in-out rounded-xl overflow-hidden aspect-[4/3]">
              ...
              <div
                className={`${
                  index % 4 === 0
                    ...
                    ? "bg-[#10a5bc]"
                    : "bg-[#2D9596]"
                } bg-opacity-35 w-full relative group p-3 lg:p-7 flex items-end shadow-md mx-auto hover:bg-opacity-100 duration-500 ease-in-out rounded-xl overflow-hidden aspect-[4/3]`}
              >
                <Icon
                  icon="maki:arrow"
