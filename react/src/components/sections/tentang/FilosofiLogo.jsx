...
const FilosofiLogo = () => {
    ...
    return (
        <section
            ref={target}
            className="container mx-auto relative z-30 lg:px-24 px-4 py-32 lg:py-10   "
        >
            <div className="flex w-full lg:gap-5 gap-2 items-end justify-start mb-10">
                ...
                <motion.div
                    ...
                    className="w-full lg:h-1 h-0.5 bg-gradient-to-r from-primary-skyBlue to-primary-tealBlue"
                ></motion.div>
            </div>
            <main className="w-full flex flex-col lg:flex-row items-center gap-5 justify-around">
                        ...
                        <motion.img
                            ...
                            className={`${
                                activeLogo.id === item.id
                                    ? "scale-125"
                                    : "scale-100"
                            } duration-300 ease-in-out w-full border-2 border-opacity-50 border-primary-charcoalGray object-contain aspect-square rounded-lg`}
                        />
                    ))}
                </div>
                ...
                <div className="w-4/5 lg:w-3/5 relative flex items-center">
                    <AnimatePresence>
                        ...
                        >
                            <h3 className="font-helvetica-extraBold text-2xl lg:text-4xl text-primary-tealBlue">
                                {activeLogo.title}
                            </h3>
                            <p
                                className="lg:text-2xl text-base text-primary-charcoalGray"
                                dangerouslySetInnerHTML={{
                                    __html: activeLogo.desc,
                                }}
                            ></p>
                        </motion.div>
                    </AnimatePresence>
