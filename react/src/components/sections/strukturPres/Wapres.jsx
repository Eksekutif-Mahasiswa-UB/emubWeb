        ...
        <motion.div ref={target}>
            <section className="w-full h-full flex justify-center relative overflow-hidden">
                <motion.img
                    ...
                    alt="img"
                    src={fotowapres}
                    className="w-1/5 absolute bottom-0 left-1/2  -translate-x-1/2 z-40  "
                />
                ...
                <div className="w-1/2 relative overflow-hidden">
                    ...
                    <motion.h3
                        ...
                        className=" text-white md:text-3xl text-xs lg:text-5xl font-helvetica font-extrabold absolute top-0 lg:top-5 right-3"
                    >
                        WAKIL
                    </motion.h3>
                ...
                <div className="w-1/2 overflow-hidden relative">
                    ...
                    <motion.h3
                        ...
                        className=" text-primary-tealBlue md:text-3xl text-xs lg:text-5xl font-helvetica font-extrabold absolute top-0 lg:top-5 left-3  "
                    >
                        PRESIDEN
                    </motion.h3>
                    <img
