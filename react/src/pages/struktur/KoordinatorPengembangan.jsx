...
const KoordinatorPengembangan = () => {
    ...
    return (
        <div className="font-helvetica-regular bg-primary-white pb-20">
            <Header
                bpi={Pengembangan[0].bpi}
                title={"KEMENTRIAN KOORDINATOR PENGEMBANGAN"}
            />
            ...
            <div
                ...
                } duration-300 ease-in-out w-10 lg:w-14 flex justify-center items-center border-2  aspect-square rounded-full bg-primary-tealBlue fixed bottom-5 lg:bottom-10 right-5 lg:right-10`}
            >
                <Icon
                    icon={"fluent:arrow-up-12-filled"}
                    className="text-2xl text-primary-white"
                />
            </div>
        </div>
    );
